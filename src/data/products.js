...
const productsRawData = [
    ...
    },
    {
        ...
        imageAlt: '🌰',
        categories: ['skin', 'anti-aging'],
        tags: ['فيتامين E', 'للبشرة الحساسة', 'مرطب عميق', 'لجلد الأطفال'],
        inStock: true,
        featured: false,
        description: 'زيت اللوز الحلو الطبيعي المعصور على البارد، غني بفيتامين E، الأفضل للبشرة الحساسة وبشرة الأطفال لكونه لطيفًا وآمنًا.',
        benefits: [
            'غني بفيتامين E الذي يحارب التجاعيد ويحمي خلايا البشرة من التلف',
            'مناسب للبشرة الحساسة وبشرة الأطفال كمُرطب خفيف وآمن',
            'يحسن مرونة الجلد ونعومته بشكل ملحوظ ويعالج الجفاف الشديد',
            'يساعد في تفتيح وتوحيد لون البشرة بفضل خصائصه المغذية'
        ],
        ingredients: ['زيت اللوز الحلو الطبيعي 100% - معصور على البارد'],
        howToUse: 'للوجه: ضعي قطرات قليلة ودلكي بحركات دائرية مساءً. للجسم: استخدمي بعد الاستحمام على بشرة رطبة.',
