...
const bundlesRawData = [
  ...
  // =========================================================================
  {
    ...
    ingredients: {
      ...
      makhtoum: [ "لوز", "بندق", "كاجو", "عين جمل", "سوداني مقشر",
        "تمر سعودى  ",
        "سمسم", "عسل موالح", "عسل برسيم", " عسل حبة البركة ",
        "زيت زيتون بكر",
        "بذور اليقطين"
      ]
    },
...
*نصيحة كافورال:* الاستخدام المنتظم مع الأكل يساعد على زيادة ملحوظة.
  ...
  {
  id: "genetic-hair-loss-course",
  name: "كورس الصلع الوراثي 🌿",
  description: "بدلاً من 780 جنيه | 3 زيوت طبيعية معصورة على البارد لعلاج التساقط الوراثي وتحفيز الإنبات.",
  image: "https://res.cloudinary.com/vtykvdzl/image/upload/v1785924484/photo_2026-08-05_13-06-10_eil3kk.jpg",
  imageAlt: "🌿",

  // عدل الأرقام حسب الـ IDs الموجودة في products.js
  products: [9, 4, 5],

  productNames: [
    "زيت الروزماري المعصور على البارد",
    "زيت الخروع",
    "زيت بذور اليقطين"
  ],
  ...
  benefits: [
    "يساعد على تقليل التساقط الوراثي.",
    "تحفيز الدورة الدموية داخل فروة الرأس.",
    "المساعدة على إنبات الشعر في مناطق الفراغات.",
    "تقوية البصيلات وزيادة كثافة الشعر.",
    "تقليل تأثير هرمون DHT المسؤول عن الصلع الوراثي.",
    "100% طبيعي وخالٍ من المواد الكيميائية."
  ],

  combinedUsage: `
*طريقة الاستخدام*

1. اخلط كميات متساوية من:
- زيت الروزماري
- زيت الخروع
- زيت بذور اليقطين

2. ضع نقاطاً بسيطة على فروة الرأس والأماكن التي بها فراغات.

3. دلّك فروة الرأس لمدة 5 دقائق بحركات دائرية.

4. اترك الزيت من ساعتين إلى 3 ساعات مع تغطية الرأس ببونيه أو كيس.

5. اغسل الشعر بشامبو طبي أو شامبو أطفال.

عدد مرات الاستخدام:
3 مرات أسبوعياً فقط.
`,

  usage: "يستخدم 3 مرات أسبوعياً مع تدليك فروة الرأس لمدة 5 دقائق.",

  suitableFor:
    "الرجال والنساء الذين يعانون من الصلع الوراثي أو فراغات الشعر أو التساقط المزمن.",

  season: "مناسب طوال العام",

  expectedResults:
    "قد يبدأ انخفاض التساقط وتحسن مظهر الشعر خلال 14 إلى 20 يوماً، بينما قد يبدأ ظهور إنبات جديد مع الاستمرار لمدة شهر أو أكثر، وتختلف النتائج من شخص لآخر.",

  scientificBasis:
    "يعتمد الكورس على الجمع بين زيت الروزماري لتحفيز الدورة الدموية، وزيت بذور اليقطين لدعم تقليل تأثير DHT، وزيت الخروع لدعم كثافة الشعر وتقويته."
},
];
